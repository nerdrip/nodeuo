...
const modernHandlerSource = readFileSync(new URL('../src/net/nodeuo-modern.js', import.meta.url), 'utf8');
assert.match(modernHandlerSource, /world\.commandCatalogue = catalogue/);
